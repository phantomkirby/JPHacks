...
public final class Constants {
    ...
    // Geofence parameters for JPHacks Place.
    public static final String TODAI_BUILDING_ID = "3";
    public static final double TODAI_BUILDING_LATITUDE = 35.712944;
    public static final double TODAI_BUILDING_LONGITUDE = 139.762010;
    public static final float TODAI_BUILDING_RADIUS_METERS = 60.0f;
    ...
    public static final String KEY_LATITUDE = "im.ene.androooid.jphacks.geofencing.KEY_LATITUDE";
    public static final String KEY_LONGITUDE = "im.ene.androooid.jphacks.geofencing.KEY_LONGITUDE";
    public static final String KEY_RADIUS = "im.ene.androooid.jphacks.geofencing.KEY_RADIUS";
    public static final String KEY_EXPIRATION_DURATION =
            "im.ene.androooid.jphacks.geofencing.KEY_EXPIRATION_DURATION";
    public static final String KEY_TRANSITION_TYPE =
            "im.ene.androooid.jphacks.geofencing.KEY_TRANSITION_TYPE";
    // The prefix for flattened geofence keys.
    public static final String KEY_PREFIX = "im.ene.androooid.jphacks.geofencing.KEY";
